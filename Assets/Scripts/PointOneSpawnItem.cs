...
public class PointOneSpawnItem : Spawnable
{
    private int x;
    private int y;
    private Transform position;

    public PointOneSpawnItem(){
    ...
    public void SpawnItem(){
        ...
        position = GameObject.Instantiate(GameAssets.GetInstance().point1, point1Pos, Quaternion.identity);
    }
