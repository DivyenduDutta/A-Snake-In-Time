...
public class PointTwoSpawnItem : Spawnable
{
    private int x;
    private int y;
    private Transform position;

    public PointTwoSpawnItem()
    {
    ...
    public void SpawnItem()
    {
        ...
        position = GameObject.Instantiate(GameAssets.GetInstance().point2, point2Pos, Quaternion.identity);
    }
